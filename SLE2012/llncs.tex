...
\lstset{ 
  ...
  firstnumber=auto,
	breaklines=true,
  tabsize=2,
	emph={aspect,declare, adapter, instance, pointcut, adaptee, adapts, select, UNTIL}, 
	emphstyle=\textbf,
	frame=single
	}
...
%\begin{wrapfigure}{R}{0.25\textwidth}
    %\includegraphics[width=0.23\textwidth]{images/paralel.png}
  %\caption{Parallelogram Class}
%\end{wrapfigure}
...
%We do not have write \texttt{shapes<Rectangle>(instance)} since \texttt{instance} is implicit
